...
?>
    ...
    <section class="section dashboard">
        ...
        <div id="data_view">
                    ...
                    <div class="card card-tambah h-100">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                            <div class="aksi-resep mb-3">
                                <button type="button" class="icon-tambah" id="tombol_tambah" data-bs-toggle="modal" data-bs-target="#ModalTambah" title="Tambah Resep">
                                    <i class="bi bi-plus-lg"></i>
                                    <span class="visually-hidden">Tambah Resep</span>
                                </button>
                                <button type="button" class="icon-tambah" id="tombol_cari" data-bs-toggle="modal" data-bs-target="#ModalFilter" title="Cari Resep">
            ...
            <div class="row mt-4 mb-4" id="list_resep_obat">

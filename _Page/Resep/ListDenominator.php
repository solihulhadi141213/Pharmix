<?php
    ...
    $sqlCount = "
        ...
        FROM referensi_denominator
        WHERE code_denominator LIKE ?
        OR display_denominator LIKE ?
    ";
    ...
    $sql = "
        ...
        WHERE code_denominator LIKE ?
        OR display_denominator LIKE ?
        ORDER BY display_denominator ASC
        LIMIT ? OFFSET ?
    ";
    ...
    while ($data = $result->fetch_assoc()) {
        ...
        $code_denominator    = trim($data['code_denominator'] ?? '');
        $display_denominator = trim($data['display_denominator'] ?? '');

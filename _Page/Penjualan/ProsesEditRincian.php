            ...
            if(empty($_POST['qty'])){
                ...
                if($UpdateRincian){
                    ...
                    if($UpdateTransaksi){
                        ...
                        $auto_jurnal = AutoJurnalJualBeli($Conn, $kategori_transaksi, date('Y-m-d', strtotime($tanggal)), $id_transaksi_jual_beli, $total, $pembayaran, $status);
                        ...
                        if($update_barang){
                            ...
                            $deskripsi_log="Edit Rincian Penjualan";

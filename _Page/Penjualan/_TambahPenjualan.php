                            ...
                            <div class="card-footer text-center">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <button type="submit" class="btn btn-lg btn-primary m-2 btn-block" id="ButtonSimpanTransaksiPenjualan">
                                            <i class="bi bi-save"></i> Simpan Transaksi
                                        </button>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <button type="button" class="btn btn-lg btn-warning m-2 btn-block" data-bs-toggle="modal" data-bs-target="#ModalResetTransaksi">

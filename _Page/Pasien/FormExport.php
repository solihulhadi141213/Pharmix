<?php
    ...
    if(empty($SessionIdAkses)){
        ...
        $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT id_pasien FROM anggota"));

        //Apabila Tidak Ada Data Yang Di Export
        if(empty($jml_data)){
            echo '
                <div class="alert alert-danger">
                    <small>Tidak Ada Data Pasien Yang Bisa Di Export. Silahkan Tambahkan Data Pasien Terlebih Dulu!</small>
                </div>
            ';
        }else{
            //Menampilkan Form

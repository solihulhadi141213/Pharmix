    ...
    $.ajax({
        ...
        success     : function(response){
            ...
            if(status=='success'){
                ...
                // Tampilkan Title
                $('#title_buku_besar').html(title);

                // Tampilkan Pada Baris
                $('#tabel_buku_besar').html(html);
...
$(document).ready(function() {
    ...
    $('#ModalExport').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/BukuBesar/FormExport.php',
            data        : {id_perkiraan: id_perkiraan, periode1: periode1, periode2: periode2},
            dataType    :  'JSON',
            success     : function(response){

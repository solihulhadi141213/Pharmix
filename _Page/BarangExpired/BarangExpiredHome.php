        ...
        <div class="col-lg-12">
            <div class="card card-data card-table">
                <div class="card-header text-end">
                    ...
                    <button type="button" class="btn btn-md btn-primary btn-floating" data-bs-toggle="modal" data-bs-target="#ModalTambahBarangExpired" title="Tambah Data Expired Barang">
                        <i class="bi bi-plus"></i>
                    </button>
                </div>
                <div class="table-load-container mt-3">
                    <table class="table table-hover table-responsive-card" id="tabel_barang_expired">
                        <thead>
                            <tr>
                                <th><b>No</b></th>
                                <th><b>Batch</b></th>

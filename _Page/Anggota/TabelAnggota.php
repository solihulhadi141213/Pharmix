<?php
    ...
    if(empty($keyword_by)){
        if(empty($keyword)){
            ...
            $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM anggota WHERE tanggal_masuk like '%$keyword%' OR nik like '%$keyword%' OR nama like '%$keyword%' OR email like '%$keyword%' OR kontak like '%$keyword%' OR alamat like '%$keyword%' OR ranking like '%$keyword%' OR status like '%$keyword%'"));
        }
    }else{
        if(empty($keyword)){
            $jml_data = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM anggota"));
                    ...
                    if(empty($jml_data)){
                        ...
                        if(empty($keyword_by)){
                            if(empty($keyword)){
                                ...
                                $query = mysqli_query($Conn, "SELECT*FROM anggota WHERE tanggal_masuk like '%$keyword%' OR tanggal_keluar like '%$keyword%' OR nik like '%$keyword%' OR nama like '%$keyword%' OR email like '%$keyword%' OR kontak like '%$keyword%' OR alamat like '%$keyword%' OR ranking like '%$keyword%' OR status like '%$keyword%' ORDER BY $OrderBy $ShortBy LIMIT $posisi, $batas");
                            }
                        }else{
                            if(empty($keyword)){
                                $query = mysqli_query($Conn, "SELECT*FROM anggota ORDER BY $OrderBy $ShortBy LIMIT $posisi, $batas");
                                ...
                                <td align="left">
                                    <small class="credit">
                                        <?php
                                            ...
                                            echo '</a>';
                                            echo "<br>";
                                            echo '<code class="text text-grayish">nik : '.$nik.'</code>';
                                        ?>
                                    </small>
                                </td>
                                <td align="left">
                                ...
                                <td align="left">
                                    <small class="credit">
                                        <?php
                                            ...
                                            echo '<code class="text text-grayish">'.$alamat.'</code><br>';

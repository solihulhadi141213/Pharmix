...
?>
    <div class="pagetitle">
        <h1>
            <a href="">
                <i class="bi bi-cart-check"></i> Kategori Operasional</a>
            </a>
        </h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active"> Kategori Operasional</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <small>
                        Berikut ini adalah halaman pengelolaan data kategori transaksi operasional.
            ...
            <div class="col-lg-12">
                <div class="card card-data card-table">
                    ...
                    <div class="table-load-container mt-3">
                        <table class="table table-hover table-responsive-card" id="tabel_jenis_transaksi">
                            <thead>
                                <tr>
                                    <th><b>No</b></th>
